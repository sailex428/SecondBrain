package io.sailex.aiNpc.database;

import io.sailex.aiNpc.AiNPCServer;
import java.io.File;
...
public class SqliteClient {
	...
	private void initDataBaseDir() {
		File sqlDbDir = new File(FabricLoader.getInstance().getConfigDir().toFile() + AiNPCServer.MOD_ID + "sqlite_db");
		if (sqlDbDir.mkdirs()) {
