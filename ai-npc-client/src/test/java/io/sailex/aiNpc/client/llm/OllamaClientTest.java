...
public class OllamaClientTest {
    ...
    @Test
    public void testGenerateResponse() throws OllamaBaseException, IOException, InterruptedException {
    ...
    @Test
    public void testGenerateResponseWithException() throws OllamaBaseException, IOException, InterruptedException {
        String userPrompt = "hello, how are you?";
        String systemPrompt = "some world context";
    ...
    @Test
    public void testGenerateResponseWithNullPrompt() throws OllamaBaseException, IOException, InterruptedException {
        String systemPrompt = "some world context";
    ...
    @Test
    public void testGenerateEmbedding() throws IOException, OllamaBaseException, InterruptedException {
        String prompt = "hello, how are you?";
        Float[] expectedEmbedding = {1.0f, 2.0f, 3.0f, 4.0f};
        ...
        Float[] embedding = ollamaClient.generateEmbedding(Collections.singletonList(prompt));
    ...
    @Test
    public void testGenerateEmbeddingWithException() throws IOException, OllamaBaseException, InterruptedException {
        String prompt = "hello, how are you?";
    ...
    @Test
    public void testGenerateEmbeddingWithNullPrompt() throws IOException, OllamaBaseException, InterruptedException {
        Float[] embedding = ollamaClient.generateEmbedding(null);
